...
function UI.create()
    ...
    UI.frame=f
    f:SetWidth(190);f:SetHeight(76);f:SetFrameStrata("TOOLTIP");f:SetToplevel(true);f:SetClampedToScreen(true);f:SetAlpha(1);f:SetScale(1)
    ...
    if f.SetBackdrop then
        ...
        f:SetBackdropBorderColor(0.35,0.65,1,0.9)
    end
...
function UI.render()
    ...
    local ok=pcall(UI.layout)
    if not ok then
        f.planBefore={};f.planAfter={}
    end
