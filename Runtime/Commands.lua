...
SlashCmdList["GUARDPOINT"]=function(msg)
    ...
    elseif msg=="test" then
        ...
        S.expire=U.now()+(NS.LichKing.Timing.ReaperDuration or 5.1);S.nextAt=nil;S.used={}
    ...
    elseif msg=="pre" then
        S.test=false;S.active=false;S.reaper=0;S.nextNumber=1;S.nextAt=U.now()+(NS.LichKing.Timing.Prewarn or 8.0);S.plan=nil;UI.frame:Hide()
